...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        foreach (['location','branch','bank','account','area','dealer','mesurment','groups','method','departmenttype','departmentlevel','item','vendor','deapartment','employee','vechile'] as $resource) {
