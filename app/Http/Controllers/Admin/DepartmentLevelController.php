...
class DepartmentLevelController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.departmentlevel.index');
    }
    ...
    public function getall(Request $request)
    {
        ...
        $branchs = Departmentlevel::where('firm_id',$compId)->get();
    ...
    {
        try {
            $User = Departmentlevel::findOrFail($request->userId);
    ...
    {
        try {
            Departmentlevel::where('id', $id)->delete();
    ...
    public function store(Request $request)
    {
        ...
        Departmentlevel::create($dataUser);
        return response()->json([
            'success' => true,
    ...
    public function update(Request $request)
    {
        ...
        $user = Departmentlevel::find($request->id);
        if ($user) {
