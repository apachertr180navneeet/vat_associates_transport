...
class DepartmentTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.departmenttype.index');
    }
    ...
    public function getall(Request $request)
    {
        ...
        $branchs = Departmenttype::where('firm_id',$compId)->get();
    ...
    {
        try {
            $User = Departmenttype::findOrFail($request->userId);
    ...
    public function store(Request $request)
    {
        ...
        Departmenttype::create($dataUser);
        return response()->json([
            'success' => true,
    ...
    public function update(Request $request)
    {
        ...
        $user = Departmenttype::find($request->id);
        if ($user) {
