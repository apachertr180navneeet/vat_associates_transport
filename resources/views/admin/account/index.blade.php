...
<div class="container-fluid flex-grow-1 container-p-y">
    <div class="row">
        <div class="col-md-6 text-start">
            <h5 class="py-2 mb-2">
                <span class="text-primary fw-light">Account</span>
            </h5>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Branch Add</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select id="nature" class="form-select form-select">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="opening_blance" class="form-label">Opening Blanace</label>
                        <input type="text" id="opening_blance" class="form-control" placeholder="Enter Opening Blanace" />
                        <small class="error-text text-danger"></small>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Branch Edit</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select id="editnature" class="form-select form-select">
                            <option value="">select</option>
                            <option value="income">Income</option>
                            <option value="expence">Expence</option>
                        </select>
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="edit_opening_blance" class="form-label">Opening Blanace</label>
                        <input type="text" id="edit_opening_blance" class="form-control" placeholder="Enter Opening Blanace" />
                        <small class="error-text text-danger"></small>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        const table = $("#branchTable").DataTable({
            processing: true,
            ajax: {
                url: "{{ route('admin.account.getall') }}",
            },
            columns: [
                {
                    data: "name",
        ...
        $('#AddItem').click(function(e) {
            ...
            $.ajax({
                url: '{{ route('admin.account.store') }}', // Adjust the route as necessary
                type: 'POST',
                data: data,
        ...
        function editUser(userId) {
            const url = '{{ route("admin.account.get", ":userid") }}'.replace(":userid", userId);
            $.ajax({
        ...
        $('#EditComapany').on('click', function() {
            ...
            $.ajax({
                url: '{{ route('admin.account.update') }}', // Update this URL to match your route
                method: 'POST',
                data: {
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = '{{ route("admin.account.destroy", ":userId") }}'.replace(":userId", userId);
                    $.ajax({
                        type: "DELETE",
                        url,
