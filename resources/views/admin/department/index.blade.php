    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Department Add</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select id="level" class="form-select form-select">
                            <option value="">select</option>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" id="descrption" class="form-control" placeholder="Enter Description" />
                        <small class="error-text text-danger"></small>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Department Edit</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select id="editlevel" class="form-select form-select">
                            <option value="">select</option>
                            @foreach ( $levels as $level )
                                <option value="{{ $level->id }}">{{ $level->name }}</option>
                            @endforeach
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="editdescrption" class="form-label">Description</label>
                        <input type="text" id="editdescrption" class="form-control" placeholder="Enter Description" />
                        <small class="error-text text-danger"></small>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function () {
        ...
        const table = $("#branchTable").DataTable({
            processing: true,
            ajax: {
                url: "{{ route('admin.deapartment.getall') }}",
            },
            columns: [
                {
                    data: "name",
                ...
                {
                    data: "departmenttypes_name",
                },
                {
                    data: "departmentlevels_name",
                },
                {
                    data: "descrption",
                },
        ...
        $('#AddItem').click(function(e) {
            ...
            $.ajax({
                url: '{{ route('admin.deapartment.store') }}', // Adjust the route as necessary
                type: 'POST',
                data: data,
        ...
        function editUser(userId) {
            const url = '{{ route("admin.deapartment.get", ":userid") }}'.replace(":userid", userId);
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#editdescrption').val(data.descrption);
        ...
        $('#EditComapany').on('click', function() {
            ...
            $.ajax({
                url: '{{ route('admin.deapartment.update') }}', // Update this URL to match your route
                method: 'POST',
                data: {
        ...
        function updateUserStatus(userId, status) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.deapartment.status') }}",
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = '{{ route("admin.deapartment.destroy", ":userId") }}'.replace(":userId", userId);
                    $.ajax({
                        type: "DELETE",
                        url,
