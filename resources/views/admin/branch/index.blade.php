            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" id="gstn" class="form-control" placeholder="Enter GSTN" />
                        <small class="error-text text-danger"></small>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="location" class="form-label">Location</label>
                        <select id="location" class="form-select form-select">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" id="editgstn" class="form-control" placeholder="Enter GSTN" />
                        <small class="error-text text-danger"></small>
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="editlocation" class="form-label">Location</label>
                        <select id="editlocation" class="form-select form-select">
                            <option value="">select</option>
                            @foreach ( $location as $locations )
                                <option value="{{ $locations->id }}">{{ $locations->name }}</option>
                            @endforeach
...
<script>
    $(document).ready(function () {
        ...
        $('#AddItem').click(function(e) {
            ...
            $.ajax({
                url: '{{ route('admin.branch.store') }}', // Adjust the route as necessary
                type: 'POST',
                data: data,
        ...
        function editUser(userId) {
            const url = '{{ route("admin.branch.get", ":userid") }}'.replace(":userid", userId);
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#editlocation').val(data.locationid);
        ...
        $('#EditComapany').on('click', function() {
            ...
            $.ajax({
                url: '{{ route('admin.branch.update') }}', // Update this URL to match your route
                method: 'POST',
                data: {
        ...
        function deleteUser(userId) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    const url = '{{ route("admin.branch.destroy", ":userId") }}'.replace(":userId", userId);
                    $.ajax({
                        type: "DELETE",
                        url,
